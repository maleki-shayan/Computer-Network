...
const string EVENTS_FILE = PHASE5_DIRECTORY + "/events.log";
const string CWND_FILE = PHASE5_DIRECTORY + "/cwnd.csv";
const string THROUGHPUT_FILE = PHASE5_DIRECTORY + "/throughput.csv";
const string SUMMARY_FILE = PHASE5_DIRECTORY + "/sender_summary.txt";
